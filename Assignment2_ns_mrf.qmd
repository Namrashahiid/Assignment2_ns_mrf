...
The categories we see here in this graph is for example age, colour, size and so on.
...
When we look at the graphs we have worked with in EDA part, we see that there are many categories we can work with in only on graph.
