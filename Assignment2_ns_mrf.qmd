...
The connection between physical gender, education and income has gotten a lot of attention lately [@averettEconomicRealityBeauty1996].
Most researchers investigate income, marital status, and hourly pay differentials by body mass (kg/m2) [@slade2017].
...
The same applies also if we restrict the sample to persons who were single and childless when the old weight was sampled (Her burde det vært en referanse). 

@caseStatureStatusHeight2008 show that stature, status, self-esteem, social dominance and discrimination is based on the association between height, earnings and labour market outcomes.
Furthermore @deatonHeightHealthDevelopment2007 shows that the height of an adult depends on genetics and by intake of food, like nutrition and the importance of balanced food .
This study also shows that low nutrition quality can cause non survival of children.
Even if they survive low nutrition quality can cause short height.

@schickHeightHumanCapital2015 shows that taller workers receive a wage earning premium caused by increasing/developing strength, size, stamina and enhanced labor productivity.
Most studies show that height and disturbance (Her mangler noe).
@persico2004 claims that this is developed and increased at a young age.
...
(Dette er en påstand som må underbygges med referanse(r))

There is much social awareness on being overweight, and Americans face much social and psychological awareness when it comes to being overweight [@mankiwOptimalTaxationHeight].
...
Some research also claims to show that taller persons are smarter than shorter ones [@pinskerEveryInchTaller2015].
Taller people seems to do better at a young age, compared to shorter ones.
There are many scientists (referanser mangler) out there who will disagree with this theory, but there is some evidence that shows that taller persons are smarter and earn more.

Studies seems to indicate that marriage has a large impact on work [@reed1989], [@korenman1991].
An important insight seems to be that marital status relies upon the consumption of the family (Er dette riktig?).
@reed1989 shows that men are more likely to marry compared to women.

Recent research shows us that mens wages rise more rapidly than expected prior to marriage [@killewaldNewEvidenceCausal2017].
The main focus of this research is that married men experience wage advantages, compared with never-married men and divorced men.

The connection between stature and favorable labor market outcomes has also been extensively documented [@lundborgHeightPremiumEarnings2009].
Some studies claim that height is a very important factor, when it comes to being productive and hence earn high wages.
(Referanser mangler)

@wangWhatCreatingHeight2020 also seems to claim that height is a significant factor in professional success .
...
@wangWhatCreatingHeight2020 shows us that height is indeed associated with higher salary income.
...
Viktigste innsikt fra figuren over er at når vi kompenserer for kjønn og utdanning så ser det ut til å være liten sammenheng mellom høyde og inntekt (linjene er tilnærmet horisontale)
