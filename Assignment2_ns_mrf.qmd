...
[(Dårle engelsk, eg veit :P) We see form the table that we have a lot of different marital variables. The next thing we are going to do is to make the marital variables to married/not married.]{.underline}
